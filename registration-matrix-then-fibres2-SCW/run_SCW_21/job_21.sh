...
#SBATCH -A scw1701
#SBATCH --job-name=21-register     # Job name
#SBATCH --output register-21-%j.out     # Job name
#SBATCH --error register-21-%j.err     # Job name
#
...
date > registration-matrix-then-fibres2-SCW/run_SCW_21/runtime_21
python3 registration-matrix-then-fibres.py --input Tutorial2/sino.raw --output registration-matrix-then-fibres2-SCW/run_SCW_21/
date >> registration-matrix-then-fibres2-SCW/run_SCW_21/runtime_21
