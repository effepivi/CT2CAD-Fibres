...
#SBATCH -A scw1701
#SBATCH --job-name=27-register     # Job name
#SBATCH --output register-27-%j.out     # Job name
#SBATCH --error register-27-%j.err     # Job name
#
...
date > registration-matrix-then-fibres2-SCW/run_SCW_27/runtime_27
python3 registration-matrix-then-fibres.py --input Tutorial2/sino.raw --output registration-matrix-then-fibres2-SCW/run_SCW_27/
date >> registration-matrix-then-fibres2-SCW/run_SCW_27/runtime_27
