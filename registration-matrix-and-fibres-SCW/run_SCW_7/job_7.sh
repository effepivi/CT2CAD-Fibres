...
#SBATCH -A scw1701
#SBATCH --job-name=register-7     # Job name
#SBATCH --output register-7-%j.out     # Job name
#SBATCH --error register-7-%j.err     # Job name
#
...
date > validation/runtime_7
python3 validation-whole_CT.py --input Tutorial2/sino.raw --output validation/run_SCW_7/
date >> validation/runtime_7
