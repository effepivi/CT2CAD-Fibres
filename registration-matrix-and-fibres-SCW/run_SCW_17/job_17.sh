...
#SBATCH -A scw1701
#SBATCH --job-name=register-17     # Job name
#SBATCH --output register-17-%j.out     # Job name
#SBATCH --error register-17-%j.err     # Job name
#
...
date > validation/runtime_17
python3 validation-whole_CT.py --input Tutorial2/sino.raw --output validation/run_SCW_17/
date >> validation/runtime_17
